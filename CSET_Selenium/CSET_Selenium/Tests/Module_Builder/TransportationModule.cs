...
namespace CSET_Selenium.Tests.Module_Builder
{
    class TransportationModule
    {
        ...
        public class Module_Builder : BaseTest
        {
            ...
            [Test]
            public void TransportationModule()
            {
                ...
                //Set module details using the Transportation category
                newModule.SetModuleDetails("Transportation Test", "Test2", "'Transportation' category module test", "Transportation");
                Thread.Sleep(4000);
            }
        }
    }
