    ...
    class ElectricalModule
    {
        ...
        public class Module_Builder : BaseTest
        {
            ...
            public void ElectricalModule()
            {
                ...
                //Set module details using the Electrical category
                newModule.SetModuleDetails("Electrical Test", "Test2", "'Electrical' category module test", "Electrical");
                Thread.Sleep(4000);
            }
        }
    }
