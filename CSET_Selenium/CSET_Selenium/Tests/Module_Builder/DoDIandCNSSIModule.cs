...
namespace CSET_Selenium.Tests.Module_Builder
{
    class DoDIandCNSSIModule
    {
        ...
        public class Module_Builder : BaseTest
        {
            ...
            [Test]
            public void DoDIandCNSSIModule()
            {
                ...
                //Set module details using the DoDI and CNSSI category
                newModule.SetModuleDetails("DoDI and CNSSI Test", "Test4", "'DoDI and CNSSI' category test module", "DoDI and CNSSI");
                Thread.Sleep(4000);
            }
        }
    }
