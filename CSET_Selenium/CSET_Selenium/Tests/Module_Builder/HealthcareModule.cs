    ...
    class HealthCareModule
    {
        ...
        public class Module_Builder : BaseTest
        {
            ...
            public void HealthCareModule()
            {
                ...
                //Set module details using the Health Care category
                newModule.SetModuleDetails("Health Care Test", "Test2", "'Health Care' category module test", "Health Care");
                Thread.Sleep(4000);
            }
        }
    }
