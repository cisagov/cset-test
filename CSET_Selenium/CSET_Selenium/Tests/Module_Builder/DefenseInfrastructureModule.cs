...
{
    class DefenseInfrastructureModule
    {
        [TestFixture]
        public class Module_Builder : BaseTest
        {
            ...
            [Test]
            public void DefenseInfrastructureModule()
            {
                ...
                //Set module details using the Defense Infrastructure category
                newModule.SetModuleDetails("Defense Infrastructure Test", "Test3", "'Defense Infrastructure' category module test", "Defense Infrastructure");
                Thread.Sleep(4000);
            }
        }
    }
