    ...
    class NuclearModule
    {
        ...
        public class Module_Builder : BaseTest
        {
            ...
            public void NuclearModule()
            {
                ...
                //Set module details using the Nuclear category
                newModule.SetModuleDetails("Nuclear Test", "Test2", "'Nuclear' category module test", "Nuclear");
                Thread.Sleep(4000);
            }
        }
    }
